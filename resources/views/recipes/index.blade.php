    ...
    <div class="max-w-3xl mx-auto text-center">
        ...
        <div class="relative">
            <input type="text" id="search-input"
                   class="w-full px-5 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-pink-400 shadow-sm transition"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            @foreach ($recipes as $recipe)
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition relative">
                    ...
                    <div class="p-5">
                        <h2 class="text-xl font-bold text-pink-600 mb-1 truncate">{{ $recipe->title }}</h2>
                        <p class="text-sm text-gray-500 mb-2">{{ $recipe->category->name ?? 'Sem categoria' }}</p>
